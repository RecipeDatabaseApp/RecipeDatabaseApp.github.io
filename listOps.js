const chkTemplate = "<div id=\"[div_id]\"><input type=\"checkbox\" id=\"[chk_id]\" onclick=\"checkOff('[div_id]')\" name=\"check\"><label for=\"[chk_id]\">[chk_txt]</label></div>"

async function viewList() {
  itemExists("list")
  list = localStorage.getItem("list");

  //list = '<div id="list-content"><div id="1_div"><input type="checkbox" id="1" onclick="checkOff(\'1_div\')"><label for="1">1 14 oz can crushed pineapple, drained</label></div><div id="2_div"><input type="checkbox" id="2" onclick="checkOff(\'2_div\')"><label for="2">1 14 oz can fruit cocktail, drained</label></div><div id="3_div"><input type="checkbox" id="3" onclick="checkOff(\'3_div\')"><label for="3">1 pouch pistachio pudding mix</label></div><div id="4_div"><input type="checkbox" id="4" onclick="checkOff(\'4_div\')"><label for="4">1 8 oz container cool whip</label></div><div id="5_div"><input type="checkbox" id="5" onclick="checkOff(\'5_div\')"><label for="5">2 c mini marshmallows</label></div><div id="6_div"><input type="checkbox" id="6" onclick="checkOff(\'6_div\')"><label for="6">1 c chopped nuts (opt)</label></div></div>';
...
function clearChecked() {
  var checks = document.getElementsByName("list-content");
  itemExists("list")
  var currList = localStorage.getItem("list").split('\n')
  //for (i = 0; i < currList.length; i++) {
    //if (currList[i].includes('')
}